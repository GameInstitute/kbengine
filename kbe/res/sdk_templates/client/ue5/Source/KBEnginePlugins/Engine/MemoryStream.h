...
public:
	...
	FVector3f2D readVector2()
	{
		float X = readFloat();
		float Y = readFloat();
		return FVector3f2D(X, Y);
	}
	...
	FVector3f4 readVector4()
	{
		float X = readFloat();
		float Y = readFloat();
		float Z = readFloat();
		float W = readFloat();
		return FVector3f4(X, Y, Z, W);
	}
	...
	void writeVector2(const FVector3f2D& v)
	{
		writeFloat(v.X);
		writeFloat(v.Y);
	}
	...
	void writeVector4(const FVector3f4& v)
	{
		writeFloat(v.X);
		writeFloat(v.Y);
		writeFloat(v.Z);
