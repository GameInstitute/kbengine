...
/** Implements variant type traits for the built-in FVector3f2D type. */
template<> struct TKBVariantTraits<FVector3f2D>
{
	static int32 GetType() { return EKBVarTypes::Vector2d; }
};


/** Implements variant type traits for the built-in FVector3f4 type. */
template<> struct TKBVariantTraits<FVector3f4>
{
